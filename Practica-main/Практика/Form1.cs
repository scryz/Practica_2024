...
namespace Практика
{
    public partial class Form1 : Form
    {
                    ...
                    if (matchCB1.Count == 1)
                    {
                        ...
                        if (match1.Count >= 1)
                        {
                            ...
                            if (matchCB2.Count == 1)
                            {
                                ...
                                String line8 = numericUpDown1.Text;
                                Regex tb8 = new Regex(@"\d+");
                                MatchCollection match8 = tb8.Matches(line8);
                                if (match8.Count == 1)
                                {
                                    numericUpDown1.Text = match8[0].Value;


                                    if (textBox1.Text != "" && comboBox1.Text != "" && textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && comboBox2.Text != "" && numericUpDown1.Text != "")
                                    {
                                ...
                                {
                                    listBox1.Items.Add("Введите корректное колличество баллов по ЕГЭ");
                                }
                            }
                            else
                            {
        ...
        {
            toolTip1.SetToolTip(numericUpDown1, "Введите количество баллов по ЕГЭ абитуриента");
        }
